...
namespace VastGIS.Common.Plugins.Mef
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Property), MetadataAttribute]
    public class VastGISPluginAttribute : ExportAttribute, IPluginMetadata
    {
        ...
        public VastGISPluginAttribute()
            : base(typeof(IPlugin))
        {
            _empty = true;
        }

        public VastGISPluginAttribute(bool loadOnStartUp)
            : base(typeof(IPlugin))
        {
            _empty = true;
        ...
        public VastGISPluginAttribute(string name, string author, string guid)
            : base(typeof(IPlugin))
        {
